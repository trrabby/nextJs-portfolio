  ...
  return (
    <div>
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <Tabs>
          <div className="text-center mt-10 md:w-4/12 w-8/12 mx-auto bottom-0">
            <TabList className="bottom-0 flex justify-around items-center bg-third rounded-2xl p-2 ">
          ...
          <TabPanel>
            <div className="">
              <div className="space-y-6 pt-10">
                ...
                <ul className="md:timeline timeline-vertical timeline-middle text-gray-800">
                  <li>
                    <div
                      data-aos="fade-up"
                      data-aos-duration="1000"
                      className="timeline-start md:text-end mb-10 space-y-2 text-justify border-l-4 pl-2 border-accent flex flex-col justify-end items-end w-6/12"
                    >
                  ...
                  <li className="w-full">
                    ...
                    >
                      <div className="w-6/12">
                        ...
                        some unavoidable circumstances i had to leave study
                        there.
                      </div>
                    </div>
                  </li>
          ...
          <TabPanel>
            ...
            >
              <div className="flex justify-around w-8/12 gap-5 mt-10">
                <div data-aos="fade-down" data-aos-duration="1000">
                  <h3 className="text-xl font-bold text-primary pb-3">
                    Frontend
                  </h3>
                ...
                <div data-aos="fade-up" data-aos-duration="1000">
                  <h3 className="text-xl font-bold text-primary pb-3">Tools</h3>
                  <ul className="space-y-1">
                    <li className="flex gap-2">
                      <Image
                        className="w-5"
