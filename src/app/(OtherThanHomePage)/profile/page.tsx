...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-white dark:bg-gray-900 text-forth dark:text-forth transition-all duration-500 py-3 lg:pt-20">
      {showPasswordPopup && (
